...
I decided to write this plugin after finding out about SQLiteLib written by pablo67340 (https://github.com/pablo67340/SQLiteLib) since it seems like he is no longer maintaining the project. This plugin statically links **SQLite JDBC Driver 3.39.4.0** written by xerial (https://github.com/xerial/sqlite-jdbc).
